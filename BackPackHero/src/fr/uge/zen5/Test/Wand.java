...
public class Wand implements Weapons{
	...
	public Wand(String name,int rarity,int energycost,int damage,int protection,int manacost) {
		this.name=Objects.requireNonNull(name,"Give a name for the wand");
		this.rarity=rarity;
