...
public class MeleeWeapon implements Weapon{
	...
	public MeleeWeapon(String getName,String getRarity,int getAttackPoint,int getEnergyPoint){
		this.getName=Objects.requireNonNull(getName,"Give a name for the meleeWeapon");
